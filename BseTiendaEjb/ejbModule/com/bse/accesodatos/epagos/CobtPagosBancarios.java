...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CobtPagosBancarios.findAll", query = "SELECT c FROM CobtPagosBancarios c"),
    @NamedQuery(name = "CobtPagosBancarios.findByIdTransaccion", query = "SELECT c FROM CobtPagosBancarios c where c.cobtPagosBancariosPK.idTransaccion = :idTransaccion"),
    @NamedQuery(name = "CobtPagosBancarios.findByFacturaPagada", query = "SELECT c FROM CobtPagosBancarios c where c.nroFactura = :nroFactura and c.codRespuesta = '00'")
})
...
public class CobtPagosBancarios implements Serializable {

	private static final long serialVersionUID = 1L;

	@EmbeddedId
    protected CobtPagosBancariosPK cobtPagosBancariosPK;
    ...
    public CobtPagosBancariosPK getCobtPagosBancariosPK() {
		return cobtPagosBancariosPK;
	}

	public void setCobtPagosBancariosPK(CobtPagosBancariosPK cobtPagosBancariosPK) {
