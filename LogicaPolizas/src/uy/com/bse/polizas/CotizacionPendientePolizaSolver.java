...
public class CotizacionPendientePolizaSolver extends XMLAbstractSolver {
	...
	protected ResultXmlPL getXmlResult(ParamGenerico param) {
		return new ServiciosPolizasPersist().cotizacionPendientePoliza((ParamCotizacionPendiente) param);
	}
