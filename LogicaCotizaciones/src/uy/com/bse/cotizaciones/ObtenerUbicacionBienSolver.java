...
public class ObtenerUbicacionBienSolver extends XMLAbstractSolver{

	@Override
	protected ResultGenerico getMyResultInstance() {
		return new ResultObtenerUbicacionBien();
	}

	@Override
	protected ResultXmlPL getXmlResult(ParamGenerico param) {
		return new CotizacionesPersist().obtenerUbicacionBien( (ParamObtenerUbicacionBien) param);
	}
	...
	protected ResultGenerico parseValues(ResultXmlPL xmlResult) {
		...
		if (unParseo.generarDoc().booleanValue()) {
			return unParseo.parsearObtenerUbicacionBien();
		}
		return null;
	}
}
