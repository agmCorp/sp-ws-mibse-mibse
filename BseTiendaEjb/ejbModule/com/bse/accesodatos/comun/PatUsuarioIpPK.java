 ...
 */
@Embeddable
public class PatUsuarioIpPK implements Serializable {
    /**
	 * 
	 */
    ...
    public PatUsuarioIpPK() {
    }

    public PatUsuarioIpPK(String nombreUsuario, String ip) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PatUsuarioIpPK)) {
            return false;
        }
        PatUsuarioIpPK other = (PatUsuarioIpPK) object;
