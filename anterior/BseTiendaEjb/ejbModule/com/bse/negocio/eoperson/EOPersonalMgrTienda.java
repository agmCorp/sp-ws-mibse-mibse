...
public class EOPersonalMgrTienda implements IEOPersonalTienda {
    ...
    public PolizaOPersonalTienda emitirOPersonal( EntityManager em,
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Valida Fecha Factura - Con MENOS de 1 A�O de ANTIGUEDAD y NO SER una fecha futura
        ...
        if ( fechaDiaActual < fechaFacturaInt ) {
            ...
            logger.info(logEncabezado + " - Fecha Factura con MAS de 1 A�O de ANTIGUEDAD - Fecha Factura=["
                   + Integer.toString(fechaFacturaInt)+"] Fecha de 1 a�o atras=["+Integer.toString(fechaUnAnioAtras)+"]");
            throw new BSEExceptionTienda(CodigosErrorTienda.fecha_factura_invalida);
        }
        logger.info(logEncabezado +" - FECHA FACTURA (ANTIGUEDAD) - OK - MENOS de 1 A�O de ANTIGUEDAD - Fecha Factura["
                + Integer.toString(fechaFacturaInt) + "] >= Fecha 1 a�o atras["+Integer.toString(fechaUnAnioAtras)+"]");
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public List<PlanCoberturaTienda> consultaPlanesCobertura(EntityManager em) throws Exception, BSEExceptionTienda {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // GENERAR RESULTADO - PLANES de COBERTURA registrados en BASE pero que adem�s est�n indicados por CONFIGURACION
    ...
    public List<ItemCodiguera> consultaTiposObjetos(EntityManager em) throws Exception, BSEExceptionTienda {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // GENERAR RESULTADO - TIPOS de OBJETOS registrados en BASE pero que adem�s est�n indicados por CONFIGURACION
    ...
    public List<ItemCodiguera> consultaTiposMovilidad(EntityManager em) throws Exception, BSEExceptionTienda {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // GENERAR RESULTADO - TIPOS de MOVILIDAD registrados en BASE pero que adem�s est�n indicados por CONFIGURACION
        ArrayList<ItemCodiguera> lista = new ArrayList<ItemCodiguera>();
        if ((result != null) && (result.size() > 0)) {
            for (int i = 0; i < result.size(); i++) {
                CretTablasTienda tabla = result.get(i);
