 ...
 */
@Embeddable
public class PatParametrosPKTienda implements Serializable {
    ...
    public PatParametrosPKTienda() {
    }


    public PatParametrosPKTienda(String aplicacion, String clave, String subclave) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PatParametrosPKTienda)) {
            return false;
        }
        PatParametrosPKTienda other = (PatParametrosPKTienda) object;
