...
public class ObtenerCoberturasIntegranteNominaSolver extends XMLAbstractSolver {

	@Override
	protected ResultGenerico getMyResultInstance() {
		return new ResultObtenerCoberturasIntegranteNomina();
	}

	@Override
	protected ResultXmlPL getXmlResult(ParamGenerico param) {
		return new ConsultasPersist().obtenerCoberturasIntegranteNomina((ParamObtenerCoberturasIntegranteNomina) param);
	}
	...
	protected ResultGenerico parseValues(ResultXmlPL xmlResult) {
		...
		if (unParseo.generarDoc().booleanValue()) {
			return unParseo.parsearObtenerCoberturasIntegranteNomina();
		}
		return null;
	}
