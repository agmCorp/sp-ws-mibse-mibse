...
public class ObtenerAnexosPolizaSolver extends XMLAbstractSolver {

	@Override
	protected ResultGenerico getMyResultInstance() {
		return new ResultObtenerAnexosPoliza();
	}

	@Override
	protected ResultXmlPL getXmlResult(ParamGenerico param) {
		return new ServiciosPolizasPersist().obtenerAnexosPoliza((ParamObtenerAnexosPoliza) param);
	}
	...
	protected ResultGenerico parseValues(ResultXmlPL xmlResult) {
		...
		if (unParseo.generarDoc().booleanValue()) {
			return unParseo.parsearObtenerAnexosPoliza();
		}
		return null;
	}
}
