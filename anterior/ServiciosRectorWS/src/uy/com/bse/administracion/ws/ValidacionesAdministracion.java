...
public class ValidacionesAdministracion extends ValidacionesAbstract {
	...
	public ServiciosError validarObtenerDatosCorredor(ParamObtenerDatosCorredor param) {
	...
	public ServiciosError validarAgregarEvolante(ParamAgregarEdoc param) {
		String claveDeError = null;
		if (!this.validarLogin(param.getUsuario(), param.getClave())) {
			claveDeError = Values.CLAVEINCORRECTA;
		}
